...
import de.ovgu.featureide.ui.statistics.core.composite.lazyimplementations.genericdatatypes.HashMapNodeTwoStringsPreprocessor;
 ...
 */
public class LOCNodePreprocessor extends LazyParent {

	private final HashMap<String, Integer> featureExtensionLOCList;

	LOCNodePreprocessor(String description, HashMap<String, Integer> fExList) {
		super(description);
	...
	protected void initChildren() {
		addChild(new HashMapNodeTwoStringsPreprocessor(LOC_BY_EXTENSION, 1, featureExtensionLOCList));
