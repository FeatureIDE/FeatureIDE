 ...
 */
public class HashMapNodeTwoStringsPreprocessor extends AbstractSortModeNode {

	private HashMap<String, Integer> featureExtensionLOCList = new HashMap<String, Integer>();
	private HashMap<String, Integer> count = new HashMap<String, Integer>();
	private int side;

	public HashMapNodeTwoStringsPreprocessor(String description, int side, HashMap<String, Integer> extList) {
		super(description);
