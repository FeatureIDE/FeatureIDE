...
public class VariantDocumentationHandler extends AProjectJobHandler {
	...
	protected AbstractWizard instantiateWizard() {
		return new BuildDocWizard(DOCUMENTATION_WIZARD, "VariantDocumentation", false);
	}

	@Override
	protected void endAction() {
		CorePlugin.getDefault().buildVariantDocumentation(projects, (String) wizard.getData(WizardConstants.KEY_OUT_DOCOPTIONS));
	}
