...
public class FSTOutline extends OutlineProvider {
	...
	public FSTOutline(OutlineTreeContentProvider contentProvider, OutlineLabelProvider labelProvider) {
	...
	@Override
	public void handleUpdate(TreeViewer viewer, IFile file) {
		this.viewer = viewer;
		this.file = file;
	...
	protected void initContextMenuActions(IMenuManager manager) {
		if (featureModelManager != null) {
			final SetFeatureColorAction setFeatureColorAction = new SetFeatureColorAction(viewer, featureModelManager);
