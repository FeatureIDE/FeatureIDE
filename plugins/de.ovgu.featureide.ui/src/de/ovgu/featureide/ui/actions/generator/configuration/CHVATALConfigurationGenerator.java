 ...
 */
public class CHVATALConfigurationGenerator extends ACNFConfigurationGenerator {

	private final int t;

	public CHVATALConfigurationGenerator(ConfigurationBuilder builder, IFeatureProject featureProject, int t) {
