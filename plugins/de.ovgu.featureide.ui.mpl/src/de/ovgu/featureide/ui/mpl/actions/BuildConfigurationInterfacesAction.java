 ...
 */
public class BuildConfigurationInterfacesAction extends AProjectJobAction {
	private InterfaceWizard wizard;

	@Override
	protected boolean startAction() {
		wizard = new InterfaceWizard("Build Configuration Interfaces");
