 ...
 */
public class BuildConfigurationInterfacesAction extends AbstractProjectAction {
	@Override
	protected void action(IProject project) {
		InterfaceWizard wizard = new InterfaceWizard("Build Configuration Interfaces");
