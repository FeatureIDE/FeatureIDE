...
//			ImageDescriptor imgDesc = org.deltaj.feature.ui.wizard.Activator.getIcon("triangle.png");	
...
//			return img;
	...
	public void updateOptional(){
		...
		//extension.setCombinedOptionalFeatures((ArrayList<DOptFeature>) listViewerComb.getInput());
