...
public class AttributeUtils {
	...
	public static String[] getNumericalAttributes(IFeatureModel featureModel) {
		if (featureModel instanceof ExtendedFeatureModel) {
			...
			List<String> namesWithoutDuplicates = getDistinctAttributes(numericalAttributeNames);
	...
	private static List<String> getDistinctAttributes(List<String> numericalAttributeNames) {
		List<String> distinctList = new ArrayList<>();
		for (String string : numericalAttributeNames) {
	...
	public static String[] getBooleanAttributes(IFeatureModel featureModel) {
		if (featureModel instanceof ExtendedFeatureModel) {
			...
			List<String> namesWithoutDuplicates = getDistinctAttributes(booleanAttributeNames);
			return namesWithoutDuplicates.toArray(new String[namesWithoutDuplicates.size()]);
		}
