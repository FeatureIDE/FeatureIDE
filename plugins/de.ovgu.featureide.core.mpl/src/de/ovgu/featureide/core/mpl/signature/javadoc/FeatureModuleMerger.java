 ...
 */
public class FeatureModuleMerger extends AJavaDocCommentMerger {
	private final int featureID;
	
	public FeatureModuleMerger(InterfaceProject interfaceProject, int[] featureList, int featureID) {
	...
	protected Tag handleCommentPart(Tag tag) {
		if (tempInfoType == 0 || featureID == tempFeatureID) {
			return tag;
		} else {
			return null;
		}
