...
import de.ovgu.featureide.core.mpl.signature.abstr.AbstractStringProvider;

public class JavaStringProvider extends AbstractStringProvider {
	
	@Override
	public String getClassString(AbstractClassFragment cls, boolean shortString) {
...
//		
	...
	public static String getClassString2(AbstractClassFragment cls, boolean shortString) {
		final StringBuilder sb = new StringBuilder();
