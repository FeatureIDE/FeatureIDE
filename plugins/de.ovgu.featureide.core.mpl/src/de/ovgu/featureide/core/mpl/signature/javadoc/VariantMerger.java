...
/**
 * Modul-Comment merger for variants.
 * 
 * @author Sebastian Krieter
 */
public class VariantMerger extends AJavaDocCommentMerger {
	
	public VariantMerger(InterfaceProject interfaceProject, int[] featureList) {
