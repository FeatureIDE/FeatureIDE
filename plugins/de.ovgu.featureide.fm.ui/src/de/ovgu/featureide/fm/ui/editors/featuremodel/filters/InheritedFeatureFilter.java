...
/**
 * Checks whether a graphical feature is inherited (multi-product-lines).
 *
 * @author Joshua Sprey
 */
public class InheritedFeatureFilter implements Predicate<IGraphicalFeature> {
	...
	public boolean test(IGraphicalFeature object) {
		return (object.getObject() instanceof MultiFeature) && ((MultiFeature) object.getObject()).isInherited();
	}
