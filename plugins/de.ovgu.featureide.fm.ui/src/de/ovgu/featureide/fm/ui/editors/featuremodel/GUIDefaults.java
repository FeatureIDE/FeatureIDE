...
public interface GUIDefaults {
	...
	public static final Font DEFAULT_FONT_TINY = new Font(null, new FontData("Arial Unicode MS", 9, SWT.NORMAL));
	public static final Font DEFAULT_FONT_REGULAR = new Font(null, new FontData("Arial Unicode MS", 12, SWT.BOLD));
