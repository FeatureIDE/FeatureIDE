...
import de.ovgu.featureide.fm.ui.editors.featuremodel.operations.SetFeatureToCollapsedOperation;
...
public class CollapseAction extends SingleSelectionAction {
	...
	public void run() {
		...
		SetFeatureToCollapsedOperation op = new SetFeatureToCollapsedOperation(feature, featureModel);
