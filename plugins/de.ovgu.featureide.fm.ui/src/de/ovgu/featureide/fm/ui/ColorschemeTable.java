...
import de.ovgu.featureide.fm.core.io.IFileWriterWrapper;
...
public class ColorschemeTable {
	 ...
	 * @param featureModel
	 */
	public ColorschemeTable(IGraphicalFeatureModel featureModel) {
		this.featureModel = featureModel;
		this.colorschemeNames = new ArrayList<String>();
		reset();
	}
	
	protected ColorschemeTable(ColorschemeTable oldColorschemeTable, IGraphicalFeatureModel featureModel) {
		this.featureModel = featureModel;
	...
	public void addColorscheme(String name) {
		...
		for (IGraphicalFeature feat : featureModel.getFeatures()) {
	...
	public void saveColorsToFile(IProject project) {
		try {
			IFileWriterWrapper w = new IFileWriterWrapper(new XmlColorModelWriter(featureModel));
