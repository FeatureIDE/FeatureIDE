...
/**
 * 
 * This class creates a dialog where floors can be selected.
 * 
...
public class FloorChooseDialog extends JDialog {
	...
	private static final long serialVersionUID =
		5663011468166401169L;
	private JPanel panelFloors;
	private List<Integer> selectedFloors =
		new ArrayList<Integer>();

	public FloorChooseDialog(int maxFloors, List<Integer> disabledFloors, String description) {
