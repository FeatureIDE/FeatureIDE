...
public class MainWindow implements ActionListener {
	...
	private List<JToggleButton> listInnerElevatorControls = new ArrayList<JToggleButton>();

	public MainWindow(SimulationUnit sim) {
		this.sim = sim;
	}

	// To-Do: FIFO muss nach Service aufgerufen werden, sonst wird die GUI falsch gezeichnet. Feature Order sollte aber eigentlich stimmen
