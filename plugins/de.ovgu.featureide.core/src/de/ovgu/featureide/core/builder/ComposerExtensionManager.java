...
public class ComposerExtensionManager extends ExtensionManager<IComposerExtension> {
	...
	private ComposerExtensionManager() {
		setExtensionLoaderInternal(new EclipseExtensionLoader<IComposerExtension>(CorePlugin.PLUGIN_ID, IComposerExtension.extensionPointID,
				IComposerExtension.extensionID, IComposerExtension.class) {
