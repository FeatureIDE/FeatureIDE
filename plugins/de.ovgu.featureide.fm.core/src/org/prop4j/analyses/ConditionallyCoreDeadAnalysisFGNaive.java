 ...
 */
public class ConditionallyCoreDeadAnalysisFGNaive extends AConditionallyCoreDeadAnalysis {

	private final IFeatureGraph featureGraph;

	public ConditionallyCoreDeadAnalysisFGNaive(ISatSolver solver, IFeatureGraph featureGraph) {
		super(solver);
		this.featureGraph = featureGraph;
	}

	public ConditionallyCoreDeadAnalysisFGNaive(SatInstance satInstance, IFeatureGraph featureGraph) {
		super(satInstance);
		this.featureGraph = featureGraph;
	}
