 ...
 */
public class ConditionallyCoreDeadAnalysisFGNaive3 extends AConditionallyCoreDeadAnalysis {

	private final ITraverser traverser;

	public ConditionallyCoreDeadAnalysisFGNaive3(ISatSolver solver, IFeatureGraph2 featureGraph) {
		super(solver);
		this.traverser = featureGraph.traverse();
	}

	public ConditionallyCoreDeadAnalysisFGNaive3(SatInstance satInstance, IFeatureGraph2 featureGraph) {
		super(satInstance);
		this.traverser = featureGraph.traverse();
	}
