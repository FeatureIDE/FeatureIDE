 ...
 */
public class ConditionallyCoreDeadAnalysisSatNaive extends AConditionallyCoreDeadAnalysis {

	public ConditionallyCoreDeadAnalysisSatNaive(ISatSolver solver) {
		super(solver);
	}

	public ConditionallyCoreDeadAnalysisSatNaive(SatInstance satInstance) {
		super(satInstance);
	}
