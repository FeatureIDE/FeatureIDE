 ...
 */
public class ConditionallyCoreDeadAnalysisFGImproved extends AConditionallyCoreDeadAnalysis {

	private final IFeatureGraph featureGraph;

	public ConditionallyCoreDeadAnalysisFGImproved(ISatSolver solver, IFeatureGraph featureGraph) {
		super(solver);
		this.featureGraph = featureGraph;
	}

	public ConditionallyCoreDeadAnalysisFGImproved(SatInstance satInstance, IFeatureGraph featureGraph) {
		super(satInstance);
		this.featureGraph = featureGraph;
	}
