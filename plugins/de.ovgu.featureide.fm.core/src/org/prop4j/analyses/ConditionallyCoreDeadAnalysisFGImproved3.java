 ...
 */
public class ConditionallyCoreDeadAnalysisFGImproved3 extends AConditionallyCoreDeadAnalysis {

	private final ITraverser traverser;

	public ConditionallyCoreDeadAnalysisFGImproved3(ISatSolver solver, IFeatureGraph2 featureGraph) {
		super(solver);
		this.traverser = featureGraph.traverse();
	}

	public ConditionallyCoreDeadAnalysisFGImproved3(SatInstance satInstance, IFeatureGraph2 featureGraph) {
		super(satInstance);
		this.traverser = featureGraph.traverse();
	}
