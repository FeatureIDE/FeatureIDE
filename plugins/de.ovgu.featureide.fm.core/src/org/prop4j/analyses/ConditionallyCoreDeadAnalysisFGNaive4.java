 ...
 */
public class ConditionallyCoreDeadAnalysisFGNaive4 extends AConditionallyCoreDeadAnalysis {

	private final ITraverser traverser;

	public ConditionallyCoreDeadAnalysisFGNaive4(ISatSolver solver, IFeatureGraph2 featureGraph) {
		super(solver);
		this.traverser = featureGraph.traverse();
	}

	public ConditionallyCoreDeadAnalysisFGNaive4(SatInstance satInstance, IFeatureGraph2 featureGraph) {
		super(satInstance);
		this.traverser = featureGraph.traverse();
	}
