 ...
 */
public class ConditionallyCoreDeadAnalysisSatImproved extends AConditionallyCoreDeadAnalysis {

	public ConditionallyCoreDeadAnalysisSatImproved(ISatSolver solver) {
		super(solver);
	}

	public ConditionallyCoreDeadAnalysisSatImproved(SatInstance satInstance) {
		super(satInstance);
	}
