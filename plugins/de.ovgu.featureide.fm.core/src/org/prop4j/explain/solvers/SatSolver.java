...
public interface SatSolver extends SatProblem {
	 ...
	 *
	 * <pre> <i>f</i> = <i>f<sub>1</sub></i> &and; &hellip; &and; <i>f<sub>n</sub></i> = (<i>f<sub>11</sub></i> &or; &hellip; &or; <i>f<sub>1m</sub></i>) &and;
	 * &hellip; &and; (<i>f<sub>n1</sub></i> &or; &hellip; &or; <i>f<sub>nk</sub></i>) </pre> </p> Then, <i>f</i> is satisfiable iff there is a variable
	 * assignment that satisfies <i>f</i> (i.e. makes it evaluate to true). Such an assignment is called {@link #getModel() model}. </p>
	 *
