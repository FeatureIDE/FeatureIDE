 ...
 */
public class CopyOfMultiSolver extends BasicSolver {
	...
	public CopyOfMultiSolver(CopyOfMultiSolver oldSolver) {
		super(oldSolver);
	...
	public CopyOfMultiSolver(Node cnf, List<IFeature> featureList) {
		this(new SatInstance(cnf, featureList));
	}

	public CopyOfMultiSolver(SatInstance satInstance) {
		super(satInstance);
	...
	@Override
	public void checkAllVariables(int vars, Tester t) {
	...
	public CopyOfMultiSolver clone() {
		return new CopyOfMultiSolver(this);
	}
