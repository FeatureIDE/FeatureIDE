...
/**
 * FeatureIDE's default {@link IFeature} implementation as the starting point for user-defined implementations.
 * <br/>
 * <br/>
 * This class implements the minimum functionality required for a {@link IFeature} class and further functionality from {@link AFeatureModelElement}. The first
 * provides getter and setter of the feature's <i>properties</i>, <i>custom properties</i>, and the feature's <i>structure</i> (for more information,
 * see {@link IFeature} documentation). The second implements FeatureIDE's internal functionality to identify a given feature inside a feature model, and to
 * provide event listening capabilities with the listener/observer pattern.
 * <br/>
 * <br/>
 * This class is intended to be a starting point for user-defined implementation, such that a subclass of <code>AFeature</code> only have to provide an
 * implementation of {@link IFeature#clone(IFeatureModel, IFeatureStructure)}. FeatureIDE provides a default non-abstract implementation
 * {@link de.ovgu.featureide.fm.core.base.impl.Feature Feature} which extends <code>AFeature</code> in this sense.
 * <br/>
 * <br/>
 * An instance of a subclass of <code>AFeature</code> is intended to be instantiated by a {@link IFeatureModelFactory}.
 * <br/>
 * <br/>
 * <b>Example</b><br/>
 * The following example demonstrate the creation of a new feature called <i>FeatureA</i> using FeatureIDE's default <code>AFeature</code> implementation
 ...
 * </pre>
 * </code>
 * A unified handling of certain <code>AFeature</code> (<code>IFeature</code>) implementations (in terms of conviennent methods) can be achieved with the use of
 * {@link de.ovgu.featureide.fm.core.base.FeatureUtils FeatureUtils} helper class.
 * <br/>
 * <br/>
 * <b>Notes on equals method</b>: The <code>AFeature</code> implementation inherits the {@link Object#equals(Object)} capability from
 * {@link AFeatureModelElement}. The feature equality is defined as the equality of the underlying internal identifiers per feature.
 * <br/>
 * <br/>
 *
