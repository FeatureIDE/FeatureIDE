...
public final class FMFactoryManager extends FactoryManager<IFeatureModel> {
	 ...
	 * Note:</b> If possible, use {@link #getFactory(Path, IPersistentFormat)} or {@link #getFactory(IFeatureModel)} instead to ensure that the correct factory
	 * is used for the underlying feature model file.
	 *
