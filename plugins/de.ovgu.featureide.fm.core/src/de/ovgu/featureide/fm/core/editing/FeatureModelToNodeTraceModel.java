 ...
 * For example, a feature model containing a parent feature <i>P</i>, a child feature <i>C</i> and a constraint <i>C</i> &rArr; <i>P</i>, the target formula would be:
...
public class FeatureModelToNodeTraceModel implements Cloneable {
	...
	public enum Origin {
		...
		/**
		 * <p>
		 * Denotes that the clause's origin is a {@link FeatureStructure#getChildren() child feature} not directed {@link CHILD_UP upward} or {@link CHILD_DOWN downward}.
		 * </p>
		 * 
		 * <p>
		 * This is the case for {@link FeatureStructure#isAlternative() alternative groups}, which (in addition to upward and downward parts) contain the following part:
		 * <pre>atmost1(<i>Child<sub>1</sub></i>, &hellip;, <i>Child<sub>n</sub></i>)</pre>
		 * </p>
		 */
		CHILD_HORIZONTAL,
	...
	public static class FeatureModelElementTrace implements Cloneable {
		...
		protected FeatureModelElementTrace(IFeature parent, Collection<IFeature> children, boolean up) {
			this.origin = up ? Origin.CHILD_UP : Origin.CHILD_DOWN;
			this.element = parent;
			this.elements = new LinkedHashSet<IFeatureModelElement>(children);
		}
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			FeatureModelElementTrace other = (FeatureModelElementTrace) obj;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FeatureModelToNodeTraceModel other = (FeatureModelToNodeTraceModel) obj;
		if (traces == null) {
