...
public abstract class AFeatureGraph implements IFeatureGraph {
	...
	public static final byte EDGE_NONE =
		0b00000000, // 0x00;
			EDGE_00Q =
				0b00000001, // 0x01,
			EDGE_00 =
	...
	public static final byte MASK_0_CLEAR =
		(byte) 0b11110000, // 0xf3,
			MASK_1_CLEAR =
				(byte) 0b00001111, // 0xf3,
			MASK_Q_CLEAR =
				(byte) 0b10101010; // 0xf3,
	...
	public static boolean isWeakEdge(byte edge) {
		return isEdge(edge, EDGE_00Q)
			|| isEdge(edge, EDGE_01Q)
			|| isEdge(edge, EDGE_10Q)
			|| isEdge(edge, EDGE_11Q);
	}

	public static boolean isStrongEdge(byte edge) {
		return isEdge(edge, EDGE_00)
			|| isEdge(edge, EDGE_01)
			|| isEdge(edge, EDGE_10)
			|| isEdge(edge, EDGE_11);
	}
	...
	public int getFeatureIndex(String name) {
		return index[satInstance.getVariable(name)
			- 1];
	}
