...
public class StringTable {
	...
	public static final String CONFIGURATION_DIALOGS_CONSTRAINT_TOOLTIP =
		"If this option is not selected, upon opening a feature diagramm FeatureIDE will ask you if you want to open the ConstraintView. Uncheck this if you want to change the default behaviour.";
