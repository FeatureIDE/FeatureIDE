...
public class StringTable {
	...
	public static final String FEATURE_STUBS_GENERATION_STARTED_ = "Feature Stubs Generation started.";
	...
	public static final String VELVET_FEATUREMODEL_IMPORTED = "Velvet-Featuremodel imported";
	public static final String VALID = "valid";
	public static final String UNKNOWN = "Unknown";
	public static final String EMPTY_FEATURE_MODEL = "Empty Feature Model";
	public static final String AT_MOST_ONE_THE_FEATURESETS_ARE_PRESENT = "at most one the featureSets are present";
	...
	public static final String CONNECTIONTYPE_OF_ROOTFEATURE = "Connectiontype of Rootfeature";
	...
	public static final String IS_NO_VALID_INTEGER_VALUE = "is no valid Integer Value";
	public static final String IS_NO_VALID_FEATURE_NAME = " is no valid feature name";
	...
	public static final String WHITESPACE_BEFORE_AND_AFTER_QUOTED_FEATURENAME_REQUIRED = "Whitespace before and after quoted Featurename required";
	public static final String NO_SYMBOL = " no symbol ";
	public static final String IS_NOT_SUPPORTED = " is not supported";
	public static final String EXPRESSION_IS_NOT_IN_CNF = "expression is not in cnf";
	...
	public static final String SELECT_THE_CORRESPONDING_FEATUREMODEL_ = "Select the corresponding Featuremodel.";
	...
	public static final String YOUR_CONSTRAINT_IS_NOT_SATISFIABLE_ = "Your constraint is not satisfiable.";
	...
	public static final String EDIT_YOUR_CONSTRAINT = "Edit your Constraint";
	public static final String UPDATE = "Update";
	public static final String CREATE = "Create";
	public static final String SAVE_YOUR_CHANGES = "save your changes";
	public static final String ADD_YOUR_NEW_CONSTRAINT = "add your new constraint";
	...
	public static final String YOUR_INPUT_CONSTAINS_SYNTAX_ERRORS_ = "Your input constains syntax errors.";
	public static final String CONSTRAINT_CONTAINS_ONE_UNKNOWN_FEATURE_NAME_ = "Constraint contains one unknown feature name.";
	...
	public static final String VOIDS_MODEL = "voids model";
	...
	public static final String UPDATING_RESULTS_TAUTOLOGY_CHECK___ = "Updating results tautology check...";
	public static final String UPDATING_RESULTS_FOR_SATISFIABLE_CHECK___ = "Updating results for satisfiable check...";
	public static final String UPDATING_RESULTS_FOR_VOIDS_MODEL___ = "Updating results for voids model...";
	...
	public static final String UPDATING_RESULTS_FOR_REDUNDANCY___ = "Updating results for redundancy...";
	...
	public static final String CONSTRAINT_IS_UNSATISFIABLE_AND_MAKES_THE_FEATURE_MODEL_VOID_ = " Constraint is unsatisfiable and makes the feature model void. ";
	...
	public static final String UNABLE_TO_DELETE_THIS_FEATURES_UNTIL_ALL_RELEVANT_CONSTRAINTS_ARE_REMOVED_ = "Unable to delete this features until all relevant constraints are removed.";
	...
	public static final String LOOKS_FOR_OPEN_CLAUSES_IN_THE_CNF_REPRESENTATION_OF_THE_FEATURE_MODEL_AND_HIGHLIGHTS_THE_CORRESPONDING_FEATURES_ = "Looks for open clauses in the CNF representation of the feature model and highlights the corresponding features.";
	public static final String TRIES_TO_FIND_FEATURES_WHICH_LEAD_TO_A_VALID_CONFIGURATION_BY_SOLVING_A_SATISFIABILITY_PROBLEM_ = "Tries to find features which lead to a valid configuration by solving a satisfiability problem.";
	...
	public static final String CONSTRAINT_MAKES_THE_MODEL_VOID = "Constraint makes the model void";
	...
	public static final String MINIMUM_HORIZONTALLY_DISTANCE_TO_BORDER = "Minimum horizontally distance to border";
	public static final String MINIMUM_VERTICALLY_DISTANCE_TO_BORDER = "Minimum vertically distance to border";
	public static final String HORIZONTALLY_SPACE_BETWEEN_TWO_FEATURES = "Horizontally space between two features";
	public static final String VERTICALLY_SPACE_BETWEEN_TWO_FEATURES = "Vertically space between two features";
	...
	public static final String TRIED_TO_OPEN_NULL_PROJECT_ = "Tried to open null project.";
	public static final String DESTINATIONFOLDER_NOT_ACCESSIBLE_OR_WRONG_PATH = "Destinationfolder not accessible or wrong path";
	...
	public static final String GIVE_A_NAME_FOR_THE_SOFTWARE_PRODUCT_LINE = "Give a name for the Software Product Line";
	public static final String PROJECT_NAME = "Project Name";
	public static final String GIVE_A_NAME_FOR_THE_NEW_SOFTWARE_PRODUCT_LINE = "Give a name for the new Software Product Line";
	...
	public static final String IMPORT_PRODUCTS_INTO_A_SIMPLE_SOFTWARE_PRODUCT_LINE = "Import products into a simple Software Product Line";
	public static final String MIGRATION_IS_CURRENTLY_NOT_SUPPORTED_FOR_THE_SELECTED_COMPOSER__PLEASE_CHOOSE_ANOTHER_ONE = "Migration is currently not supported for the selected Composer. Please choose another one";
	public static final String DEFINES_THE_PRODUKT_BASED_STRATEGY_ = "Defines the produkt-based strategy.";
	...
	public static final String SEARCHES_FOR_TEST_CASED_IN_THE_GENERATED_PRODUCTS_AND_EXECUTES_THEM_ = "Searches for test cased in the generated products and executes them.";
	public static final String DEFINE_THE_T_FOR_T_WISE_SAMPLING_ = "Define the t for t-wise sampling.";
	public static final String DEFNIES_WHETHER_THE_PRODUKTS_ARE_GENERATED_INTO_SEPARATE_PROJECTS_OR_INTO_A_FOLDER_IN_THIS_PROJECT_ = "Defnies whether the produkts are generated into separate projects or into a folder in this project.";
	...
	public static final String SATSOLVER_OVERFLOW = "Satsolver overflow";
	...
	public static final String THE_GENERATOR_NR_ = "The Generator nr. ";
	...
	public static final String BUILDS_ALL_CURRENT_CONFIGURATIONS = "Builds all current configurations";
	public static final String BUILD_ALL_VALID_PROGRAM_VARIANTS_ = "Build all valid program variants.";
	public static final String CREATE_A_NEW_PROJECT_FOR_EACH_VARIANT = "Create a new project for each variant";
	...
	public static final String MAXIMUM_FEATURES_PER_DIRECTIVE = "Maximum features per directive";
	public static final String MINIMUM_FEATURES_PER_DIRECTIVE = "Minimum features per directive";
	public static final String AVERAGE_FEATURES_PER_DIRECTIVE = "Average features per directive";
	...
	public static final String EXPORT_STATISTICS_INTO_CSV = "Export statistics into csv";
	...
	public static final String DOUBLE_CLICK_TO_SELECT_ALL_CHILDNODES = "double-click to select all childnodes";
	...
	public static final String YOUR_CHOOSEN_TIMEOUT_MAY_NOT_BE_ENOUGH_TO_SHOW_THE_EXACT_RESULT_ = "your choosen timeout may not be enough to show the exact result.";
	...
	public static final String UPDATING_FEATURESTATISTICSVIEW = "Updating FeatureStatisticsView";
	...
	public static final String UPDATE_COLLABORATION_VIEW = "Update Collaboration View";
	...
	public static final String BUILD_COLLABORATIONMODEL = "Build collaborationmodel";
	...
	public static final String THIS_IS_NO_FEATURE_PROJECT = "This is no feature project";
	...
	public static final String THE_BUILD_PATH_IS_SET_TO_THE_JAVA_PROJECTS_SOURCE_PATH_AUTOMATICALLY = "The build path is set to the java projects source path automatically";
	...
	public static final String ENTER_THE_NAME_OF_THE_COLORSCHEME_ = "Enter the name of the Colorscheme.";
	...
	public static final String SETS_THE_PATH_OF_FEATUREFOLDERS_ = "Sets the path of featurefolders.";
	public static final String SETS_THE_PATH_OF_CONFIGURATIONFILES_ = "Sets the path of configurationfiles.";
	...
	public static final String NEW_MULTI_FEATURE_PROJECT = "New Multi-Feature Project";
	...
	public static final String HERE_YOU_SELECT_THE_FEATURES_FOR_THE_NEW_INTERFACE_ = "Here you select the features for the new interface.";
	...
	public static final String HERE_YOU_SELECT_THE_PROJECT_YOU_WANT_TO_IMPORT_FROM_ = "Here you select the project you want to import from.";
	...
	public static final String SELECTED_ONLY_FULLY_COMPATIBLE_PROJECTS_ = "Selected only fully compatible projects. ";
	...
	public static final String GENARATOR_NR_ = "Genarator nr. ";
