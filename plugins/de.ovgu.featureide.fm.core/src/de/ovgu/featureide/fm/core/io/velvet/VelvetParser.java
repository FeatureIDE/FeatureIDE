...
public class VelvetParser extends Parser {
	...
	public static final int ABSTRACT =
		4;
	public static final int ACONSTR =
		5;
	public static final int ATTR =
		6;
	public static final int ATTR_OP_EQUALS =
		7;
	public static final int ATTR_OP_GREATER =
		8;
	public static final int ATTR_OP_GREATER_EQ =
		9;
	public static final int ATTR_OP_LESS =
		10;
	public static final int ATTR_OP_LESS_EQ =
		11;
	public static final int ATTR_OP_NOT_EQUALS =
		12;
	public static final int BASEEXT =
		13;
	public static final int BOOLEAN =
		14;
	public static final int CINTERFACE =
		15;
	...
	public static final int ID =
		33;
	public static final int IDPath =
		34;
	public static final int IMPORT =
		35;
	public static final int IMPORTINSTANCE =
		36;
	public static final int IMPORTINTERFACE =
		37;
	...
	public static final int OP_AND =
		45;
	public static final int OP_EQUIVALENT =
		46;
	public static final int OP_IMPLIES =
		47;
	...
	public static final int SL_COMMENT =
		53;
	public static final int SOMEOF =
		54;
	public static final int START_C =
		55;
	public static final int START_R =
		56;
	...
	public static final int USE =
		60;
	public static final int VAR_BOOL =
		61;
	public static final int VAR_FLOAT =
		62;
	...
	public final VelvetParser.velvetModel_return velvetModel() throws RecognitionException {
		...
		Token EOF4 =
			null;
		VelvetParser.imp_return imp1 =
			null;

		VelvetParser.concept_return concept2 =
			null;

		VelvetParser.cinterface_return cinterface3 =
			null;
		...
		try {
			...
			// Velvet.g:94:4: ( imp )? ( concept | cinterface ) EOF
			{
				...
				EOF4 =
					(Token) match(input, EOF, FOLLOW_EOF_in_velvetModel481);
				EOF4_tree =
			...
			recover(input, re);
			retval.tree =
				(Tree) adaptor.errorNode(input, retval.start, input.LT(-1), re);
		...
		try {
			...
			// Velvet.g:98:4: ( IMPORT name SEMI )+
			{
				...
				loop3: do {
					...
					{
						IMPORT5 =
							(Token) match(input, IMPORT, FOLLOW_IMPORT_in_imp493);
						...
						SEMI7 =
							(Token) match(input, SEMI, FOLLOW_SEMI_in_imp497);
	...
	public final VelvetParser.concept_return concept() throws RecognitionException {
		...
		Token COLON10 =
			null;
		VelvetParser.conceptBaseExt_return conceptBaseExt11 =
			null;

		VelvetParser.instanceImports_return instanceImports12 =
			null;

		VelvetParser.interfaceImports_return interfaceImports13 =
			null;

		VelvetParser.interfaceImports_return interfaceImports14 =
			null;

		VelvetParser.instanceImports_return instanceImports15 =
			null;

		VelvetParser.interfaceImports_return interfaceImports16 =
			null;

		VelvetParser.instanceImports_return instanceImports17 =
			null;
		...
		try {
			...
			{
				CONCEPT8 =
					(Token) match(input, CONCEPT, FOLLOW_CONCEPT_in_concept521);
				stream_CONCEPT.add(CONCEPT8);

				ID9 =
					(Token) match(input, ID, FOLLOW_ID_in_concept523);
				stream_ID.add(ID9);
				...
				{
					COLON10 =
						(Token) match(input, COLON, FOLLOW_COLON_in_concept530);
				...
				// 106:2: -> ^( CONCEPT ID ( conceptBaseExt )? ( instanceImports )? ( interfaceImports )? ( definitions )? )
				{
					// Velvet.g:106:5: ^( CONCEPT ID ( conceptBaseExt )? ( instanceImports )? ( interfaceImports )? ( definitions )? )
					{
						...
						root_1 =
							(Tree) adaptor.becomeRoot(
									stream_CONCEPT.nextNode(), root_1);
	...
	public final VelvetParser.cinterface_return cinterface() throws RecognitionException {
		...
		Token COLON21 =
			null;
		VelvetParser.conceptBaseExt_return conceptBaseExt22 =
			null;
		...
		try {
			...
			{
				CINTERFACE19 =
					(Token) match(input, CINTERFACE, FOLLOW_CINTERFACE_in_cinterface593);
				stream_CINTERFACE.add(CINTERFACE19);

				ID20 =
					(Token) match(input, ID, FOLLOW_ID_in_cinterface595);
				stream_ID.add(ID20);
				...
				{
					COLON21 =
						(Token) match(input, COLON, FOLLOW_COLON_in_cinterface599);
				...
				// 110:2: -> ^( CINTERFACE ID ( conceptBaseExt )? definitions )
				{
					// Velvet.g:110:5: ^( CINTERFACE ID ( conceptBaseExt )? definitions )
					{
						...
						root_1 =
							(Tree) adaptor.becomeRoot(
									stream_CINTERFACE.nextNode(), root_1);
	...
	public final VelvetParser.conceptBaseExt_return conceptBaseExt() throws RecognitionException {
		...
		try {
			...
			{
				ID24 =
					(Token) match(input, ID, FOLLOW_ID_in_conceptBaseExt632);
				stream_ID.add(ID24);
				...
				loop8: do {
					...
					{
						COMMA25 =
							(Token) match(input, COMMA, FOLLOW_COMMA_in_conceptBaseExt635);
						stream_COMMA.add(COMMA25);

						ID26 =
							(Token) match(input, ID, FOLLOW_ID_in_conceptBaseExt637);
						stream_ID.add(ID26);
	...
	public final VelvetParser.instanceImports_return instanceImports() throws RecognitionException {
		...
		Token ID31 =
			null;
		VelvetParser.name_return name29 =
			null;
		...
		try {
			...
			{
				IMPORTINSTANCE27 =
					(Token) match(input, IMPORTINSTANCE, FOLLOW_IMPORTINSTANCE_in_instanceImports662);
				stream_IMPORTINSTANCE.add(IMPORTINSTANCE27);

				ID28 =
					(Token) match(input, ID, FOLLOW_ID_in_instanceImports664);
				stream_ID.add(ID28);
				...
				loop9: do {
					...
					{
						COMMA30 =
							(Token) match(input, COMMA, FOLLOW_COMMA_in_instanceImports669);
						stream_COMMA.add(COMMA30);

						ID31 =
							(Token) match(input, ID, FOLLOW_ID_in_instanceImports671);
						stream_ID.add(ID31);
				...
				// 120:2: -> ^( IMPORTINSTANCE ( ID name )+ )
				{
					// Velvet.g:120:5: ^( IMPORTINSTANCE ( ID name )+ )
					{
						...
						root_1 =
							(Tree) adaptor.becomeRoot(
									stream_IMPORTINSTANCE.nextNode(), root_1);
	...
	public final VelvetParser.interfaceImports_return interfaceImports() throws RecognitionException {
		...
		Token ID37 =
			null;
		VelvetParser.name_return name35 =
			null;
		...
		try {
			...
			{
				IMPORTINTERFACE33 =
					(Token) match(input, IMPORTINTERFACE, FOLLOW_IMPORTINTERFACE_in_interfaceImports702);
				stream_IMPORTINTERFACE.add(IMPORTINTERFACE33);

				ID34 =
					(Token) match(input, ID, FOLLOW_ID_in_interfaceImports704);
				stream_ID.add(ID34);
				...
				loop10: do {
					...
					{
						COMMA36 =
							(Token) match(input, COMMA, FOLLOW_COMMA_in_interfaceImports709);
						stream_COMMA.add(COMMA36);

						ID37 =
							(Token) match(input, ID, FOLLOW_ID_in_interfaceImports711);
						stream_ID.add(ID37);
				...
				// 125:2: -> ^( IMPORTINTERFACE ( ID name )+ )
				{
					// Velvet.g:125:5: ^( IMPORTINTERFACE ( ID name )+ )
					{
						...
						root_1 =
							(Tree) adaptor.becomeRoot(
									stream_IMPORTINTERFACE.nextNode(), root_1);
	...
	public final VelvetParser.definitions_return definitions() throws RecognitionException {
		...
		try {
			...
			{
				START_C40 =
					(Token) match(input, START_C, FOLLOW_START_C_in_definitions757);
				...
				END_C42 =
					(Token) match(input, END_C, FOLLOW_END_C_in_definitions761);
	...
	public final VelvetParser.definition_return definition() throws RecognitionException {
		...
		VelvetParser.nonFeatureDefinition_return nonFeatureDefinition43 =
			null;

		VelvetParser.featureGroup_return featureGroup44 =
			null;

		VelvetParser.nonFeatureDefinition_return nonFeatureDefinition45 =
			null;

		VelvetParser.feature_return feature46 =
			null;

		VelvetParser.feature_return feature47 =
			null;

		VelvetParser.nonFeatureDefinition_return nonFeatureDefinition48 =
			null;
	...
	public final VelvetParser.nonFeatureDefinition_return nonFeatureDefinition() throws RecognitionException {
		...
		VelvetParser.constraint_return constraint49 =
			null;

		VelvetParser.use_return use50 =
			null;

		VelvetParser.attribute_return attribute51 =
			null;

		VelvetParser.description_return description52 =
			null;
	...
	public final VelvetParser.use_return use() throws RecognitionException {
		...
		try {
			...
			{
				USE53 =
					(Token) match(input, USE, FOLLOW_USE_in_use858);
				...
				SEMI55 =
					(Token) match(input, SEMI, FOLLOW_SEMI_in_use862);
	...
	public final VelvetParser.feature_return feature() throws RecognitionException {
		...
		Token SEMI65 =
			null;
		VelvetParser.name_return name63 =
			null;
		...
		try {
			...
			// Velvet.g:155:4: ( MANDATORY ABSTRACT | ABSTRACT MANDATORY | MANDATORY | ABSTRACT )? FEATURE name ( definitions | SEMI )
			{
				...
				{
					MANDATORY56 =
						(Token) match(input, MANDATORY, FOLLOW_MANDATORY_in_feature883);
					stream_MANDATORY.add(MANDATORY56);

					ABSTRACT57 =
						(Token) match(input, ABSTRACT, FOLLOW_ABSTRACT_in_feature885);
				...
				{
					ABSTRACT58 =
						(Token) match(input, ABSTRACT, FOLLOW_ABSTRACT_in_feature889);
					stream_ABSTRACT.add(ABSTRACT58);

					MANDATORY59 =
						(Token) match(input, MANDATORY, FOLLOW_MANDATORY_in_feature891);
				...
				{
					MANDATORY60 =
						(Token) match(input, MANDATORY, FOLLOW_MANDATORY_in_feature895);
				...
				{
					ABSTRACT61 =
						(Token) match(input, ABSTRACT, FOLLOW_ABSTRACT_in_feature899);
				...
				FEATURE62 =
					(Token) match(input, FEATURE, FOLLOW_FEATURE_in_feature906);
				...
				{
					SEMI65 =
						(Token) match(input, SEMI, FOLLOW_SEMI_in_feature915);
				...
				// 157:2: -> ^( FEATURE name ( MANDATORY )? ( ABSTRACT )? ( definitions )? )
				{
					// Velvet.g:157:5: ^( FEATURE name ( MANDATORY )? ( ABSTRACT )? ( definitions )? )
					{
						...
						root_1 =
							(Tree) adaptor.becomeRoot(
									stream_FEATURE.nextNode(), root_1);
	...
	public final VelvetParser.featureGroup_return featureGroup() throws RecognitionException {
		...
		Token END_C69 =
			null;
		VelvetParser.groupType_return groupType66 =
			null;
		...
		try {
			...
			// Velvet.g:161:4: groupType START_C ( feature )+ END_C
			{
				...
				START_C67 =
					(Token) match(input, START_C, FOLLOW_START_C_in_featureGroup948);
				...
				END_C69 =
					(Token) match(input, END_C, FOLLOW_END_C_in_featureGroup953);
	...
	public final VelvetParser.description_return description() throws RecognitionException {
		...
		try {
			...
			{
				DESCRIPTION71 =
					(Token) match(input, DESCRIPTION, FOLLOW_DESCRIPTION_in_description995);
				stream_DESCRIPTION.add(DESCRIPTION71);

				STRING72 =
					(Token) match(input, STRING, FOLLOW_STRING_in_description997);
				stream_STRING.add(STRING72);

				SEMI73 =
					(Token) match(input, SEMI, FOLLOW_SEMI_in_description999);
				...
				// 172:2: -> ^( DESCRIPTION STRING )
				{
					// Velvet.g:172:5: ^( DESCRIPTION STRING )
					{
						...
						root_1 =
							(Tree) adaptor.becomeRoot(
									stream_DESCRIPTION.nextNode(), root_1);
	...
	public final VelvetParser.constraint_return constraint() throws RecognitionException {
		...
		Token SEMI79 =
			null;
		VelvetParser.constraintDefinition_return constraintDefinition77 =
			null;

		VelvetParser.attributeConstraint_return attributeConstraint78 =
			null;

		Tree CONSTRAINT74_tree =
			null;
		Tree ID75_tree =
			null;
		...
		try {
			...
			// Velvet.g:176:4: CONSTRAINT ^ ( ID EQ !)? ( constraintDefinition | attributeConstraint ) SEMI !
			{
				...
				CONSTRAINT74 =
					(Token) match(input, CONSTRAINT, FOLLOW_CONSTRAINT_in_constraint1020);
				CONSTRAINT74_tree =
					(Tree) adaptor.create(CONSTRAINT74);
				root_0 =
					(Tree) adaptor.becomeRoot(CONSTRAINT74_tree, root_0);
				...
				{
					ID75 =
						(Token) match(input, ID, FOLLOW_ID_in_constraint1024);
					ID75_tree =
						(Tree) adaptor.create(ID75);
					adaptor.addChild(root_0, ID75_tree);

					EQ76 =
						(Token) match(input, EQ, FOLLOW_EQ_in_constraint1026);
				...
				SEMI79 =
					(Token) match(input, SEMI, FOLLOW_SEMI_in_constraint1039);
	...
	public final VelvetParser.constraintDefinition_return constraintDefinition() throws RecognitionException {
		...
		VelvetParser.constraintOperand_return constraintOperand80 =
			null;

		VelvetParser.binaryOp_return binaryOp81 =
			null;
	...
	public final VelvetParser.constraintOperand_return constraintOperand() throws RecognitionException {
		...
		Token END_R86 =
			null;
		VelvetParser.unaryOp_return unaryOp83 =
			null;

		VelvetParser.constraintDefinition_return constraintDefinition85 =
			null;
		...
		try {
			...
			// Velvet.g:184:21: ( unaryOp )* ( START_R constraintDefinition END_R | name )
			{
				...
				// Velvet.g:184:31: START_R constraintDefinition END_R
				{
					...
					END_R86 =
						(Token) match(input, END_R, FOLLOW_END_R_in_constraintOperand1092);
	...
	public final VelvetParser.attribute_return attribute() throws RecognitionException {
		...
		Token SEMI92 =
			null;
		VelvetParser.intAttribute_return intAttribute88 =
			null;

		VelvetParser.floatAttribute_return floatAttribute89 =
			null;

		VelvetParser.stringAttribute_return stringAttribute90 =
			null;
		...
		try {
			...
			// Velvet.g:189:4: ( intAttribute | floatAttribute | stringAttribute | boolAttribute ) SEMI
			{
				...
				SEMI92 =
					(Token) match(input, SEMI, FOLLOW_SEMI_in_attribute1147);
	...
	public final VelvetParser.attribConstraint_return attribConstraint() throws RecognitionException {
		...
		VelvetParser.attribNumInstance_return attribNumInstance94 =
			null;

		VelvetParser.attribOperator_return attribOperator95 =
			null;

		VelvetParser.attribNumInstance_return attribNumInstance96 =
			null;

		VelvetParser.attribRelation_return attribRelation97 =
			null;

		VelvetParser.attribNumInstance_return attribNumInstance98 =
			null;

		VelvetParser.attribOperator_return attribOperator99 =
			null;

		VelvetParser.attribNumInstance_return attribNumInstance100 =
			null;
	...
	public final VelvetParser.attribNumInstance_return attribNumInstance() throws RecognitionException {
		...
		Token INT102 =
			null;
		VelvetParser.name_return name103 =
			null;
		...
		try {
			...
			// Velvet.g:210:4: INT
			{
				...
				INT102 =
					(Token) match(input, INT, FOLLOW_INT_in_attribNumInstance1254);
				INT102_tree =
	...
	public final VelvetParser.intAttribute_return intAttribute() throws RecognitionException {
		...
		try {
			...
			// Velvet.g:215:16: VAR_INT ! name ( EQ ! INT )?
			{
				...
				VAR_INT104 =
					(Token) match(input, VAR_INT, FOLLOW_VAR_INT_in_intAttribute1271);
				...
				{
					EQ106 =
						(Token) match(input, EQ, FOLLOW_EQ_in_intAttribute1277);

					INT107 =
						(Token) match(input, INT, FOLLOW_INT_in_intAttribute1280);
					INT107_tree =
						(Tree) adaptor.create(INT107);
	...
	public final VelvetParser.floatAttribute_return floatAttribute() throws RecognitionException {
		...
		try {
			...
			// Velvet.g:216:18: VAR_FLOAT ! name ( EQ ! FLOAT )?
			{
				...
				VAR_FLOAT108 =
					(Token) match(input, VAR_FLOAT, FOLLOW_VAR_FLOAT_in_floatAttribute1289);
				...
				{
					EQ110 =
						(Token) match(input, EQ, FOLLOW_EQ_in_floatAttribute1295);

					FLOAT111 =
						(Token) match(input, FLOAT, FOLLOW_FLOAT_in_floatAttribute1298);
					FLOAT111_tree =
	...
	public final VelvetParser.stringAttribute_return stringAttribute() throws RecognitionException {
		...
		try {
			...
			// Velvet.g:217:18: VAR_STRING ! name ( EQ ! STRING )?
			{
				...
				VAR_STRING112 =
					(Token) match(input, VAR_STRING, FOLLOW_VAR_STRING_in_stringAttribute1306);
				...
				{
					EQ114 =
						(Token) match(input, EQ, FOLLOW_EQ_in_stringAttribute1312);

					STRING115 =
						(Token) match(input, STRING, FOLLOW_STRING_in_stringAttribute1315);
					STRING115_tree =
						(Tree) adaptor.create(STRING115);
	...
	public final VelvetParser.boolAttribute_return boolAttribute() throws RecognitionException {
		...
		try {
			...
			// Velvet.g:218:17: VAR_BOOL ! name ( EQ ! BOOLEAN )?
			{
				...
				VAR_BOOL116 =
					(Token) match(input, VAR_BOOL, FOLLOW_VAR_BOOL_in_boolAttribute1324);
				...
				{
					EQ118 =
						(Token) match(input, EQ, FOLLOW_EQ_in_boolAttribute1330);

					BOOLEAN119 =
						(Token) match(input, BOOLEAN, FOLLOW_BOOLEAN_in_boolAttribute1333);
					BOOLEAN119_tree =
						(Tree) adaptor.create(BOOLEAN119);
	...
	static final String DFA5_minS =
		"\1\44\2\41\1\uffff\2\41\2\21\1\41\2\uffff\1\41\2\uffff\2\41\2\21";
	static final String DFA5_maxS =
		"\1\67\2\41\1\uffff\2\42\2\67\1\41\2\uffff\1\41\2\uffff\2\42\2\67";
