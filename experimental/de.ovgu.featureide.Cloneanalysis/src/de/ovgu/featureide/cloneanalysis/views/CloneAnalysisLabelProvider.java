...
public class CloneAnalysisLabelProvider extends LabelProvider implements ITableLabelProvider
{
	...
	public String getColumnText(Object obj, int index)
	{
		if (obj instanceof Clone)
		{
			...
			switch(index){
			case 0 : return "Clone";
			case 1 : return String.valueOf(((Clone) obj).getOccurences().size()*clone.getLineCount());
			case 2 : return String.valueOf(clone.getLineCount());
			case 3 : return String.valueOf(clone.getTokenCount());
			case 4 : return String.valueOf(clone.getDistinctFiles().size());
			case 5 : return	clone.getCloneVariantType().toString();
			case 6 : return "";
				default: 
					return "TODO";
			}
		} else
		{
			if (obj instanceof CloneOccurence)
			{
				...
				case 1 : return "";
				case 2 : return String.valueOf(occurence.getClone().getLineCount());
