...
//	{}
	...
	{
//		matchViewer = new TableViewer(parent, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL);
...
//				.setHelp(matchViewer.getControl(), "de.ovgu.featureide.code.Cloneanalysis.viewer");
...
//			public void run()
//			{
//				TreeItem<VariantAwareClone> selectedItem = matchViewer.getSelectionModel().getSelectedItem();
...
//		});
	...
	{
//		MessageDialog.openInformation(matchViewer.getControl().getShell(), "Sample View", message);
	}
