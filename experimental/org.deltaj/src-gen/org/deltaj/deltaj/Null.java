 ...
 * <ul>
 *   <li>{@link org.deltaj.deltaj.Null#getNull <em>Null</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.deltaj.deltaj.DeltajPackage#getNull()
 * @model
 * @generated
 */
public interface Null extends Expression
{
   ...
   * @see #setNull(String)
   * @see org.deltaj.deltaj.DeltajPackage#getNull_Null()
   * @model
   * @generated
   */
  String getNull();
  ...
  /**
   * Sets the value of the '{@link org.deltaj.deltaj.Null#getNull <em>Null</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
