...
public class BFeatureModelAnalyzerWithRuntimeConstraints {
	...
	@Test
	@Record(samples = 5)
	@Constraint(samples = 5, allowedMedianDeviation = 2200)
	...
	@Test
	@Record(samples = 5)
	@Constraint(samples = 5, allowedMedianDeviation = 2000)
	...
	@Test
	@Record(samples = 5)
	@Constraint(samples = 5, allowedMedianDeviation = 3000)
	...
	@Test
	@Record(samples = 5)
	@Constraint(samples = 5, allowedMedianDeviation = 150)
	...
	@Test
	@Record(samples = 5)
	@Constraint(samples = 5, allowedMedianDeviation = 50)
	...
	@Test
	@Record(samples = 5)
	@Constraint(samples = 5, allowedMedianDeviation = 1400)
	...
	@Test
	@Record(samples = 5)
	@Constraint(samples = 5, allowedMedianDeviation = 160)
