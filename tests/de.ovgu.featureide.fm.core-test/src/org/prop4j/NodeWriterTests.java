...
public class NodeWriterTests {
	...
	public void testChoose() {
		testEquals(new Choose(2, "A", "B", "C", "D", "E")
				, "choose2(A, B, C, D, E)"
		);
	}
	...
	public void testAtLeast() {
		testEquals(new AtLeast(3, "A", "B", "C", "D", "E")
				, "atleast3(A, B, C, D, E)"
		);
	}
	...
	public void testAtMost() {
		testEquals(new AtMost(4, "A", "B", "C", "D", "E")
				, "atmost4(A, B, C, D, E)"
		);
	}
	...
	public void testNestedNotNode() {
		testEquals(new Not(new Not(new Not("A")))
				, "-(-(-A))"
		);
	}
	...
	public void testNestedNotLiteral() {
		 ...
		 */
		testEquals(new Literal(new Literal(new Literal("A", false), false), false)
				, "---A"
		);
	}
	...
	public void testNestedChoose() {
		testEquals(new Choose(314,
				...
				"C",
				"D")
				, "choose314(A, choose3(A, B, C, D), B, C, D)"
		);
	}
	...
	public void testNestedAtMost() {
		testEquals(new AtMost(2,
				new AtMost(123, "A", "B"),
				new AtMost(456, "B", "C"))
				, "atmost2(atmost123(A, B), atmost456(B, C))"
		);
	}
	...
	public void testVariablesFoo() {
		testEquals(new And(
				"Foo",
				new AtMost(3, "Foo", "Bar", "Baz"))
				, "Foo & atmost3(Foo, Bar, Baz)");
	}
	...
	public void testOrderAnd() {
		testEquals(new And(
				...
				new AtLeast(1, "A"),
				new AtMost(1, "A"))
				, "-A & A & B & (A | B) & (A => B) & (A <=> B) & choose1(A) & atleast1(A) & atmost1(A)");
	}
